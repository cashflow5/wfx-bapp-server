...
public class HttpServletRequestRedisWrapper extends javax.servlet.http.HttpServletRequestWrapper {
	...
	public HttpSession getSession(boolean create) {
		return new HttpSessionSidRedisWrapper(this.sid, super.getSession(create));
	}
